    ...
    try {
        ...
        const newPost = await databases.createDocument(
            ...
            ID.unique(),
            {
                ...
                video: videoUrl,
                prompt: form.prompt,
                transcript: form.transcript, // Add this line
                creator: form.userId,
            }
        )
...
export const sendPasswordResetOTP = async (email) => {
    try {
        // Use cloud.appwrite.io as the redirect URL since it's an allowed domain
        await account.createRecovery(email, 'https://cloud.appwrite.io');
        return email;
    } catch (error) {
...
export const verifyOTPAndChangePassword = async (userId, secret, newPassword) => {
    try {
        // Complete the recovery (password reset) process
